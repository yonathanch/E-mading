            ...
            <div class="card-body">
              ...
              <p class="mb-4">
                  <?php
                      if(isset($_GET['pesan'])){
                        if($_GET['pesan'] == 'gagal'){
                          echo '<i class="text-danger"> login failed!! username and password do not match!<i> ';
                        }
                        else if($_GET['pesan'] == 'empty') {
                          echo '<i class="text-danger">username and password cannot be empty<i> ';
                        }
                        else if($_GET['pesan'] == 'notfound') {
                          echo '<i class="text-danger">username not available! <i> ';
                        }
                        else if($_GET['pesan'] == 'notlogin') {
                          echo '<i class="text-danger"> You must log in to access the admin page! <i> ';
                        }
                        else if($_GET['pesan'] == 'logout') {
                          echo '<i class="text-danger"> you have successfully logged out! <i> ';
                        }
                      }
                  ?>
