        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.php" class="app-brand-link">
              <span class="app-brand-logo demo text-info">
                <svg
                  width="25"
                  viewBox="0 0 25 42"
                  version="1.1"
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="index.php" class="menu-link">
                ...
                <div data-i18n="Analytics">Manage Article</div>
              </a>
            </li>
        </ul>
        </aside>
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                    E-Mading admin page <a href="../index.php" target="_blank" class="ms-3 btn btn-sm btn-icon btn-outline-info">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="../files/profil/profil.jpg" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Yonathan C</span>
